...
var Process = (function(Process) {
   ...
   * run function
   */
  Process.module = angular.module('process_plugin', ['hawtioCore'])
  ...
  Process.module.run(function(workspace, viewRegistry, layoutFull) {
    ...
    workspace.topLevelTabs.push({
      ...
      href: function() { return "#/process_plugin"; },
      isActive: function(workspace) { return workspace.isLinkActive("process_plugin"); }
   ...
   * @param jolokia
   *
   * The controller for process.html, only requires the jolokia
